...
#if FFT_LIMB_BITS == 64
#   include "decintt_answer_64.inc"
#   include "decintt_limit_64.inc"
#elif FFT_LIMB_BITS == 32
#   include "decintt_answer_32.inc"
#   include "decintt_limit_32.inc"
#else
#   error "Unknown value of FFT_LIMB_BITS."
#endif
